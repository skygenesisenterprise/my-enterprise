...
# Contributing to Aether Meet

Thank you for your interest in contributing to **Aether Meet**!  
...
**Aether Meet** is an open-source email client licensed under **Apache licence 2.0**, with both:
...
We follow a [Code of Conduct](https://github.com/skygenesisenterprise/aether-meet/CODE_OF_CONDUCT.md) to ensure a safe, respectful, and inclusive environment.  
...
Open a [GitHub Discussion](https://github.com/skygenesisenterprise/aether-meet/discussions)
Or reach out to us at [contact@skygenesisenterprise.com](mailto:contact@skygenesisenterprise.com)

Thank you for helping improve Aether Meet 💌
